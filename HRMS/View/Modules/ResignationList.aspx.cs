...
<div class='page'>
  ...
  <p>We wish you all the best for your future endeavors.</p>
        ...
        protected void rptPageNumbers_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                CommonBL errorlog = new CommonBL();
                errorlog.fnStoreErrorLog("ResignationList", "rptPageNumbers_ItemCommand", "Exception Message" + ex.Message + "Strace=" + ex.StackTrace, UserId);
            }
        }
        protected void lnkPrevPage_Click(object sender, EventArgs e)
        {
            ...
            {
                CommonBL errorlog = new CommonBL();
                errorlog.fnStoreErrorLog("ResignationList", "lnkPrevPage_Click", "Exception Message" + ex.Message + "Strace=" + ex.StackTrace, UserId);
            }
        }
        protected void lnkNextPage_Click(object sender, EventArgs e)
        {
            ...
            {
                CommonBL errorlog = new CommonBL();
                errorlog.fnStoreErrorLog("ResignationList", "lnkNextPage_Click", "Exception Message" + ex.Message + "Strace=" + ex.StackTrace, UserId);
            }
        }
