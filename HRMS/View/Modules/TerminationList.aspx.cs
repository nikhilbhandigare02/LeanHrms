    ...
    public partial class TerminationList : System.Web.UI.Page
    {
        ...
        protected void btnclear_click(object sender, EventArgs e)
        {
            try
            {
                ...
                paginationContainer.Visible = false; // hide pagination
            }
            catch (Exception ex)
            {
        ...
        private void GoToPage(int selectedPageIndex)
        {
            ...
            {
                CommonBL errorlog = new CommonBL();
                errorlog.fnStoreErrorLog("EmployeeAction", "GoToPage", "Exception Message" + ex.Message + "Strace=" + ex.StackTrace, UserId);
            }
        }
