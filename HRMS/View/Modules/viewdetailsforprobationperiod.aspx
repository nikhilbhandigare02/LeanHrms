<%@ Page Title="" Language="C#" MasterPageFile="~/View/Layout/Site1.Master" AutoEventWireup="true" CodeBehind="viewdetailsforprobationperiod.aspx.cs" Inherits="HRMS.View.Modules.viewdetailsforprobationperiod" %>
                            ...
                            <asp:GridView runat="server" ID="gridview" class="table custom-gridview" AutoGenerateColumns="false" OnRowCommand="gvUsers_RowCommand"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Action" ItemStyle-Width="80px">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkView" runat="server" CommandName="updateprobationperiod" CommandArgument='<%# Eval("UserId") %>' title="Edit User">
